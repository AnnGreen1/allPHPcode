...
<head>
  ...
  <link rel="stylesheet" href="../layui/css/layui.css?t=1632428048260" media="all">
  <style>
    body{margin: 10px;}
...
<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-1707583634195460"
...
<script src="../layui/layui.js?t=1632428048260"></script>
<script>
layui.config({
...
layui.use(function(){ //亦可加载特定模块：layui.use(['layer', 'laydate', function(){
  ...
  table.render({
    elem: '#demo'
    ,height: 420
    ,url: 'https://layui.itze.cn/demo/table/user/user.json' //数据接口
    ,title: '用户表'
    ,page: true //开启分页
