    ...
    <ul class="layui-nav layui-nav-tree">
      <li class="layui-nav-item layui-nav-itemed">
        ...
        <dl class="layui-nav-child">
          ...
          <dd><a href="userlist.php">添加列表</a></dd>
        </dl>
      </li>
      <li class="layui-nav-item">
        <a href="userlist.php">新闻管理</a>
        <dl class="layui-nav-child">
          <dd><a href="">新闻列表</a></dd>
          <dd><a href="">添加分类</a></dd>
        </dl>
      </li>
      <li class="layui-nav-item"><a href="userlist.php">云市场</a></li>
      <li class="layui-nav-item"><a href="userlist.php">发布商场</a></li>
    </ul>
  </div>
</div>