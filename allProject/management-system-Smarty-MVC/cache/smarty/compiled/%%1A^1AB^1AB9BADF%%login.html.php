<?php /* Smarty version 2.6.32, created on 2022-04-09 09:57:25
         compiled from login.html */ ?>
<!--
/*
 * @Description: 登录页面视图view
 * @Version: 1.0
 ...
 */
 ...
 <body class="layui-bg-green">
   <div id="login">
     ...
     <form class="layui-form" action="./index.php?controler=Login&method=login" method="post">
